...
public class PointInPolygonComputation {
	 ...
	 * @param _list_objectId List of ObjectIds (ID for polygons).
	 * @param serviceIdentifier Defines which web service will be used.
	 ...
	 */
	public void getPolygonBboxFromWFSForUnloading(String polygonOrBbox, PointPolygon pp,  String url_geofenceWfs){
		//gets boundingbox or polygons from WFS. Coords+ObjectId are extracted and added to list.
		Networking net = new Networking();		
		String xml_WfsGeofenceResponse = net.sendGET2getGeofenceFromWFS(url_geofenceWfs);	
		ArrayList<ArrayList<String>> list_coords_objectid = 
				new ParserXmlJson().extractCoordsFromWfsXml(xml_WfsGeofenceResponse, url_geofenceWfs, "unloading");
	...
	public void getPolygonBboxFromWFSForWithin(String polygonOrBbox, PointPolygon pp,  String url_geofenceWfs){
		Networking net = new Networking();		
		String xml_WfsGeofenceResponse = net.sendGET2getGeofenceFromWFS(url_geofenceWfs);	
