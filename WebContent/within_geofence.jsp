...
<table class="tg" align="center">
  ...
  <tr>
    <td class="tg-031e" colspan="2"><p> This service checks whether a  truck is located within a predefined geofence (geographic polygon) that implicitly also contains a temporal component (e.g. estimated drivetime of 15 minutes to a predefined destination).
    <br>Please provide the necessary URLs, if you wish to load the predefined geofence and distribute the desired data to a WebSocket.<br>
    </p></td>
  </tr> 

    <tr>
    <td class="tg-f2ue">URL to get only BoundingBox of Polygons</td>
    <td class="tg-z2zr" style="font-size: 14px;"><input id="urlWfsBoundingBox_withinGeofence" type="text" name="urlWfsBoundingBox_withinGeofence" size="65" placeholder="provide a url to a WFS to get only bounding box" 
...
<a  class="tooltip_custom">
  ...
  <tr>
    ...
    <td class="tg-z2zr" style="font-size: 14px;"><input id="urlWebSocketURI" type="text" name="urlWebSocketURI" size="65" placeholder="provide a url to a WebSocket" 
...
<br>		
  ...
  <tr>
    ...
    <td align="right">  <input formaction="<%=request.getContextPath()%>/WithinGeofenceHandler" formmethod="POST" class="btn btn-colour a" type="submit" value="Stop active Service"/> </td>
                    <%}else{ %>
    <td></td>
    <td align="right">  <input formaction="<%=request.getContextPath()%>/WithinGeofenceHandler" formmethod="POST" class="btn btn-colour a" type="submit" value="Save Configuration and Start Service"/> </td>                
                    <%} %>
...
<br/>
  ...
  <button type="button" class="btn btn-colour a" data-toggle="collapse" data-target="#WebSocketFeed" >Display WebSocket Feed</button></p>  
